...
const styles = StyleSheet.create({
    ...
    weekDayText: { flex: 1, textAlign: 'center', color: '#888', fontWeight: 'bold', fontSize: 12 },
    grid: { flexDirection: 'row', flexWrap: 'wrap' },
    dayCell: { width: (width - 70) / 7, height: 45, justifyContent: 'center', alignItems: 'center', marginBottom: 5, borderRadius: 12 },

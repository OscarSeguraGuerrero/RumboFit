...
async function main() {
  const ejercicios = [
    ...
    { nombre: 'Press Inclinado', grupo_muscular: 'Pecho', material: 'Barra', nivel_minimo: 'Intermedio', es_senior_safe: false, dificultad: 3, categoria: 'Fuerza', descripcion: 'Ã‰nfasis en la parte superior del pectoral.' },
    ...
    { nombre: 'Cruce de Poleas', grupo_muscular: 'Pecho', material: 'Polea', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 2, categoria: 'Fuerza', descripcion: 'TensiÃ³n constante en poleas.' },
    { nombre: 'Flexiones (Push-ups)', grupo_muscular: 'Pecho', material: 'Peso Corporal', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 2, categoria: 'Fuerza', descripcion: 'Empuje horizontal bÃ¡sico.' },
    { nombre: 'Press en MÃ¡quina', grupo_muscular: 'Pecho', material: 'Maquina', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 1, categoria: 'Fuerza', descripcion: 'Empuje guiado muy seguro para iniciaciÃ³n.' },

    // --- ESPALDA (TracciÃ³n) ---
    { nombre: 'Dominadas', grupo_muscular: 'Espalda', material: 'Peso Corporal', nivel_minimo: 'Atleta', es_senior_safe: false, dificultad: 5, categoria: 'Fuerza', descripcion: 'TracciÃ³n vertical avanzada.' },
    { nombre: 'JalÃ³n al Pecho', grupo_muscular: 'Espalda', material: 'Polea', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 2, categoria: 'Fuerza', descripcion: 'Sustituto seguro de las dominadas.' },
    { nombre: 'Remo con Barra', grupo_muscular: 'Espalda', material: 'Barra', nivel_minimo: 'Intermedio', es_senior_safe: false, dificultad: 4, categoria: 'Fuerza', descripcion: 'TracciÃ³n horizontal pesada.' },
    { nombre: 'Remo con Mancuerna', grupo_muscular: 'Espalda', material: 'Mancuerna', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 2, categoria: 'Fuerza', descripcion: 'Remo unilateral mÃ¡s manejable.' },
    ...
    { nombre: 'Sentadilla con Mancuernas', grupo_muscular: 'Piernas', material: 'Mancuerna', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 2, categoria: 'Fuerza', descripcion: 'Sentadilla mÃ¡s segura para seniors.' },
    ...
    { nombre: 'Peso Muerto Rumano', grupo_muscular: 'Piernas', material: 'Barra', nivel_minimo: 'Intermedio', es_senior_safe: false, dificultad: 3, categoria: 'Fuerza', descripcion: 'Ã‰nfasis en isquios.' },
    ...
    { nombre: 'ExtensiÃ³n de CuÃ¡driceps', grupo_muscular: 'Piernas', material: 'Maquina', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 1, categoria: 'Fuerza', descripcion: 'Aislamiento de cuÃ¡driceps.' },
    { nombre: 'ElevaciÃ³n de Talones', grupo_muscular: 'Piernas', material: 'Mancuerna', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 1, categoria: 'Fuerza', descripcion: 'Trabajo de gemelos.' },
    ...
    { nombre: 'Press Militar con Mancuernas', grupo_muscular: 'Hombros', material: 'Mancuerna', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 2, categoria: 'Fuerza', descripcion: 'Empuje vertical mÃ¡s equilibrado.' },
    ...
    { nombre: 'PÃ¡jaros (Deltoides Posterior)', grupo_muscular: 'Hombros', material: 'Mancuerna', nivel_minimo: 'Intermedio', es_senior_safe: true, dificultad: 2, categoria: 'Fuerza', descripcion: 'Aislamiento hombro posterior.' },
    ...
    // --- BRAZOS ---
    { nombre: 'Curl de BÃ­ceps con Barra', grupo_muscular: 'Brazos', material: 'Barra', nivel_minimo: 'Intermedio', es_senior_safe: false, dificultad: 2, categoria: 'Fuerza', descripcion: 'ClÃ¡sico de bÃ­ceps.' },
    { nombre: 'Curl de BÃ­ceps con Mancuernas', grupo_muscular: 'Brazos', material: 'Mancuerna', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 1, categoria: 'Fuerza', descripcion: 'BÃ­ceps con giro, muy manejable.' },
    { nombre: 'Curl Martillo', grupo_muscular: 'Brazos', material: 'Mancuerna', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 1, categoria: 'Fuerza', descripcion: 'Ã‰nfasis en braquial.' },
    { nombre: 'Press FrancÃ©s', grupo_muscular: 'Brazos', material: 'Barra', nivel_minimo: 'Intermedio', es_senior_safe: false, dificultad: 3, categoria: 'Fuerza', descripcion: 'TrÃ­ceps pesado.' },
    { nombre: 'ExtensiÃ³n en Polea Alta', grupo_muscular: 'Brazos', material: 'Polea', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 1, categoria: 'Fuerza', descripcion: 'Aislamiento de trÃ­ceps.' },
    { nombre: 'Fondos en Paralelas (Dips)', grupo_muscular: 'Brazos', material: 'Peso Corporal', nivel_minimo: 'Atleta', es_senior_safe: false, dificultad: 4, categoria: 'Fuerza', descripcion: 'Empuje potente de trÃ­ceps.' },

    // --- CORE / ABDOMINALES ---
    { nombre: 'Plancha (Plank)', grupo_muscular: 'Core', material: 'Peso Corporal', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 2, categoria: 'Fuerza', descripcion: 'Estabilidad isomÃ©trica.' },
    { nombre: 'Deadbug', grupo_muscular: 'Core', material: 'Peso Corporal', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 1, categoria: 'Core Funcional', descripcion: 'CoordinaciÃ³n y estabilidad lumbar segura.' },
    ...
    { nombre: 'Crunch Abdominal', grupo_muscular: 'Core', material: 'Peso Corporal', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 1, categoria: 'Fuerza', descripcion: 'FlexiÃ³n abdominal bÃ¡sica.' },
    { nombre: 'ElevaciÃ³n de Piernas Colgado', grupo_muscular: 'Core', material: 'Peso Corporal', nivel_minimo: 'Intermedio', es_senior_safe: false, dificultad: 3, categoria: 'Fuerza', descripcion: 'FlexiÃ³n de cadera y abdomen en barra.' },

    // --- MOVILIDAD Y ESTIRAMIENTO ---
    { nombre: 'Gato-Camello', grupo_muscular: 'Espalda/Core', material: 'Peso Corporal', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 1, categoria: 'Movilidad', descripcion: 'Movilidad vertebral y alivio de tensiÃ³n.' },
    { nombre: 'Apertura de Cadera', grupo_muscular: 'Piernas', material: 'Peso Corporal', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 1, categoria: 'Movilidad', descripcion: 'Libera tensiÃ³n en psoas y glÃºteos.' },
    { nombre: 'RotaciÃ³n de Tronco', grupo_muscular: 'Espalda', material: 'Peso Corporal', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 1, categoria: 'Movilidad', descripcion: 'Mejora la torsiÃ³n de la columna.' },
    { nombre: 'Caminar', grupo_muscular: 'Global', material: 'Peso Corporal', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 1, categoria: 'Cardio', descripcion: 'Actividad aerÃ³bica de bajo impacto.' },
    { nombre: 'Estiramiento dinÃ¡mico', grupo_muscular: 'Global', material: 'Peso Corporal', nivel_minimo: 'Principiante', es_senior_safe: true, dificultad: 1, categoria: 'Estiramiento', descripcion: 'PreparaciÃ³n articular previa al entreno.' }
  ];
